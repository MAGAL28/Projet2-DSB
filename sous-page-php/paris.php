...
?>
	<section id="section1">
		...
		<li class="logo">
			<a href="http://localhost:8888/sous-page-php/club.php"><img src="../images/parisLogo.png"></a>
		</li>
	</section>
	...
	align-items: center;
	background-image: url('../images/stade-paris-saint-germain.jpg');
		...
		<div class="swiper mySwiper">
      		...
      		<div class="swiper-slide">
      			<div class="testimonialBox">
      				...
      				<div class="content">
      					<p class="pp">
      						né le 2 mars 1972 à Murphy, est un footballeur international argentin ayant évolué au poste de défenseur central et reconverti entraîneur. Il est depuis janvier 2021 entraîneur du Paris Saint-Germain. 
      							<?php 
						  try {
						  ...
						  {
						  	if (strcmp($donnees['prenom'],"Pochettino")==0) {
						  	?>
						   <br/>
      					<div class="details">
      						<div class="imgBx">
      							<img src="../images/pochettino.jpeg">
      						</div>

      						<h3><?php  echo $donnees ['nom'] . ' ' . $donnees['prenom']; } ; } /*Close boucle*/ $reponse->closeCursor(); ?><br>
      							<span>Entraineur Paris Saint-Germain</span></h3>
      		...
      		<div class="swiper-slide">
      			<div class="testimonialBox">
      				...
      				<div class="content">
						  ...
						  while($donnees = $reponse->fetch())
						  {
						  	if (strcmp($donnees['prenom'],"Neymar")==0) {
						  		echo $donnees['Historique'];
						  	?>
						   <br/>
      						<div class="details">
      						<div class="imgBx">
      							<img src="../images/neymar.jpeg">
      						</div>
    		...
    		<div class="box">
    			...
    			<p>
					<?php 
						   ...
						   //requête sql
						   $reponse = $bdd->query('SELECT * FROM MATCHS WHERE nomClub1 = "Paris Saint-Germain" or nomClub2 = "Paris Saint-Germain" ');
